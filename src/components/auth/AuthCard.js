    ...
    <div className="mx-auto grid min-h-[75vh] max-w-[104rem] items-center gap-8 px-4 py-10 pb-28 sm:px-6 lg:px-8 xl:grid-cols-[1fr_1.1fr]">
      ...
      <form onSubmit={handleSubmit(submit)} className="mx-auto w-full max-w-lg rounded-[2rem] bg-white p-8 sm:p-12 shadow-card xl:mx-0">
        ...
        <div className="mt-8 grid gap-5">
          ...
          {isRegister ? (
            <label className="flex items-start gap-3 rounded-xl bg-sky-50 p-4 text-xs font-bold text-slate-600 border border-sky-100">
          ...
          {!isForgot && !isReset && !isVerify ? (
            <>
              ...
              <div className="grid gap-3 sm:grid-cols-2">
                <button type="button" className="flex items-center justify-center gap-2 rounded-xl bg-white border border-sky-100 px-5 py-3 text-sm font-black text-slate-600 shadow-sm hover:bg-sky-50 transition">
                  {/* Google G Logo SVG */}
