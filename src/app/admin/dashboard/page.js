      ...
      <div className="overflow-hidden rounded-[2rem] bg-brand-navy p-7 text-white shadow-premium sm:p-9">
        <div className="grid gap-6 lg:grid-cols-[1fr_auto]">
          ...
          <div className="flex flex-col gap-3 justify-center">
            <Link href="/admin/prescriptions" className="inline-flex items-center justify-center gap-2 rounded-full bg-brand-yellow px-5 py-2.5 text-sm font-black text-slate-900 dark:text-white shadow-glow transition hover:-translate-y-0.5">
              Review Prescriptions (56) <ArrowRight size={15} />
            </Link>
            <Link href="/admin/vendors" className="inline-flex items-center justify-center gap-2 rounded-full bg-white dark:bg-slate-900 dark:border-slate-800/10 px-5 py-2.5 text-sm font-black text-white backdrop-blur transition hover:bg-white dark:bg-slate-900 dark:border-slate-800/20">
              Verify Vendors (5)
            </Link>
          </div>
        </div>
