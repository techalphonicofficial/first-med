    ...
    <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <div className="grid gap-8 lg:grid-cols-[1fr_300px]">
        <div className="space-y-6">
          ...
          <div className="soft-card rounded-2xl p-6 bg-white">
            ...
            <div className="relative pl-6 space-y-8 before:absolute before:inset-y-0 before:left-2.5 before:w-0.5 before:bg-sky-100">
              ...
              <div className="relative">
                ...
                <p className="text-xs font-semibold text-slate-500">July 5, 01:45 PM • Partner: Ravi Kumar</p>
              </div>
              <div className="relative">
                <div className="absolute -left-6 grid h-5 w-5 place-items-center rounded-full bg-slate-200 text-slate-400 ring-4 ring-white">
                  <Package size={12} />
                </div>
                <h3 className="font-black text-slate-400">Delivered</h3>
                <p className="text-xs font-semibold text-slate-400">Expected by 03:00 PM</p>
              </div>
            </div>
          </div>
