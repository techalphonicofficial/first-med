            ...
            <div key={label} className="soft-card rounded-[2rem] p-6">
              <div className="flex flex-wrap items-center justify-between gap-4">
                <div className="flex items-center gap-4">
                  <div className="grid h-14 w-14 place-items-center rounded-3xl bg-sky-50 dark:bg-slate-900 text-brand-blue">
                    <Icon size={24} />
                  </div>
                  <div>
                    <h2 className="font-black">{label}</h2>
                    <p className="mt-1 text-sm font-semibold text-slate-500 dark:text-white">{detail} - {type}</p>
                  </div>
                </div>
