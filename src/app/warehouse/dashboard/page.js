      ...
      <div className="overflow-hidden rounded-[2rem] bg-brand-navy p-7 text-white shadow-premium sm:p-9">
        <div className="grid gap-6 lg:grid-cols-[1fr_auto]">
          ...
          <div className="flex flex-col gap-3 justify-center">
            <Link href="/warehouse/dispatch" className="inline-flex items-center justify-center gap-2 rounded-full bg-brand-yellow px-5 py-2.5 text-sm font-black text-slate-900 shadow-glow transition hover:-translate-y-0.5">
